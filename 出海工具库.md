...
| [Next.js Boilerplate（免费）](https://github.com/ixartz/Next-js-Boilerplate) | Next.js 15 + TypeScript + Tailwind CSS 4。集成了登录(Clerk)、数据库(DrizzleORM)、i18n、测试、监控等功能 |
| [Next.js SaaS Boilerplate（免费）](https://github.com/ixartz/SaaS-Boilerplate) | Next.js + Tailwind CSS + Shadcn UI。集成了多租户、团队管理、权限控制、i18n、支付(Stripe)等SaaS功能 |
...
| [Next-JS-Landing-Page-Starter-Template](https://github.com/ixartz/Next-JS-Landing-Page-Starter-Template) | 基于 Next.js 14 + TypeScript + Tailwind CSS 的开源落地页模板 |
...
| [lemonsqueezy](https://www.lemonsqueezy.com/) | 支持个人香港卡、虚拟卡，国内开发者首选  |
